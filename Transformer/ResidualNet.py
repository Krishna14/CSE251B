...
# TODO: could add support for other models as well
model_urls = {
...
def get_resnet3d(backbone='resnet18', n_classes=101, pretrained=False, **kwargs):
    ...
    if backbone == 'resnet18':
        ...
        model = ResNet3d(Bottleneck, [3, 4, 6, 3], n_classes, **kwargs)
        if pretrained:
            model.transfer_weights(model_zoo.load_url(model_urls['resnet50']))
    else:
        # notImplementedError
        raise notImplementedError('Unsupported backbone: {}'.format(backbone))
